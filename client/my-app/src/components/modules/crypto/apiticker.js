                ...
                <div className="block-name">
                    ...
                    <div className="ticker-description">
                        <div className="description-main">
                            <a href="client/my-app/src/components/modules/crypto/apiticker" className="company-name__link"><div className="company-name">{this.state.info.full_name ? this.state.info.full_name : <span>load</span> } / TetherUS</div></a>
